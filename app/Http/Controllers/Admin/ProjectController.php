...
class ProjectController extends Controller
{
    ...
    public function delete($id)
    {
        ...
        return back()->with('notification', 'El proyecto ha sido deshabilitado correctamente.');
    }
    ...
    public function restore($id)
    {
        ...
        return back()->with('notification', 'El proyecto ha sido habilitado correctamente.');
    }
}
